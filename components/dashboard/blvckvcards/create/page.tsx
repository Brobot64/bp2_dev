...
const BlvckcardForm: React.FC = () => {
  ...
  const [filteredContentCards, setFilteredContentCards] = useState<
    ContentCard[]
  >([]);
  ...
  const updateKeywords = () => {
    ...
    const sanitizedKeywords = metakeywords
      .split('')
          ...
          <form onSubmit={handleSubmit} className={style.formWrap}>
            <div className={style.formGroup}>
              ...
              <small className={style.helpText}>
                Please enter a title for your Blvckcard (maximum 100
                characters).
              </small>
            </div>
            ...
            <div className={style.formGroup}>
              ...
              />
              <small className={style.helpText}>
                The slug will be used in the URL. It should be unique and
                lowercase.
              </small>
            </div>
            ...
            <div className={style.formGroup}>
              ...
              />
              <small className={style.helpText}>
                Enter keywords that describe your content, separated by commas.
              </small>
            </div>

            <div className={style.formGroup}>
              <label htmlFor="teaserdescription">
                Teaser Card Description (Meta Description)
              </label>
              <textarea
              ...
              ></textarea>
              <small className={style.helpText}>
                This will be the meta description used for SEO purposes. Maximum
            ...
            <div className={style.formGroup}>
              ...
              />
              <small className={style.helpText}>
                Select the date when this Blvckcard is active or relevant.
              </small>
            </div>
            ...
            <div className={style.formGroup}>
              ...
              >
                ...
                {blvckboxes.map((blvckbox) => (
                  <option key={blvckbox.id} value={blvckbox.id}>
                    {blvckbox.title}
                  </option>
                ))}
              </select>
              <small className={style.helpText}>
                Choose the Blvckbox that this card will be associated with.
              </small>
            </div>
            ...
            <div className={style.formGroup}>
              ...
              >
                ...
                {filteredContentCards.map((contentCard) => (
                  <option key={contentCard.id} value={contentCard.id}>
                    {contentCard.title}
                  </option>
                ))}
              </select>
              <small className={style.helpText}>
                Select the content card that complements this Blvckcard.
              </small>
            </div>
            ...
            <div className={style.formGroup}>
              ...
              <small className={style.helpText}>
                Upload images (JPEG, PNG, JPG, GIF) for your Blvckcard. Multiple
                images can be added, each up to 20MB. You can also upload videos
                (MP4, AVI, MOV, FLV), each up to 20MB.
              </small>
