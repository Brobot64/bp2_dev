...
const CardDetailPage: React.FC = () => {
  ...
  const fetchData = useCallback(async (page: number) => {
    ...
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_API_BASE_URL}/blvckcards/${newSlug}?page=${page}`);
  ...
  return (
    <>
      ...
      <div className={style.outerSectionsWrapper}>
        ...
        <section className={style.editorialSection} style={{backgroundImage: `url('/conclusion.jpg')`}}>
